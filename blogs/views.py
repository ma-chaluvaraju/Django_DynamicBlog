...
def search(request):
    keyword = request.GET.get('keyword', '').strip()  # Ensure keyword is stripped of extra spaces
    blogs = []
    error_message = None
    ...
    else:  # If no keyword is entered
        error_message = "Please enter a keyword to search."

    context = {
        'blogs': blogs,
        'keyword': keyword if keyword else None,  # Pass None if keyword is empty
